...
filename = '/Users/sventuri/WORKSPACE/CoarseAIR/run_N3_NASA_Orig/Test/RunKonig/output/T_10000/output/box.dat';
...
filename = '/Users/sventuri/WORKSPACE/CoarseAIR/run_N3_CG_NASA_40/Test/RunKonig/output/T_10000/output/box.dat';
formatSpec = '%20f%20f%20f%20f%20f%20f%20f%f%[^\n\r]';
fileID = fopen(filename,'r');
dataArray = textscan(fileID, formatSpec, 'Delimiter', '', 'WhiteSpace', '',  'ReturnOnError', false);
fclose(fileID);
...
filename = '/Users/sventuri/WORKSPACE/CoarseAIR/run_N3_CG_NN_40/Test/RunKonig/output/T_10000/output/box.dat';
formatSpec = '%20f%20f%20f%20f%20f%20f%20f%f%[^\n\r]';
fileID = fopen(filename,'r');
dataArray = textscan(fileID, formatSpec, 'Delimiter', '', 'WhiteSpace', '',  'ReturnOnError', false);
fclose(fileID);
