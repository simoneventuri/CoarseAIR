...
export FldrName=''
export Tran_vec=(15000) #(2500 5000 7500 10000 12500 15000 20000) 
export T0=300
...
for TTran in "${Tran_vec[@]}"; do :
  ...
  echo "[MergeExchanges]:   Moving Exchange of CO+O"
  mv $PathToDtbFldr"/kinetics/"${System1}${FldrName}"/T"$TTran"K/Exch_Type2.dat" $PathToDtbFldr"/kinetics/"${System1}${FldrName}"/T"$TTran"K/Exch_Type2_HALF.dat" 

  # echo "[MergeExchanges]:   Moving Exchange of O2+C"
  # mv $PathToDtbFldr"/kinetics/"${System2}${FldrName}"/T"$TTran"K/Exch_Type1.dat" $PathToDtbFldr"/kinetics/"${System2}${FldrName}"/T"$TTran"K/Exch_Type1_HALF.dat" 

  echo "[MergeExchanges]:   Copying Exchange of CO+O"
  scp $PathToDtbFldr"/kinetics/"${System1}${FldrName}"/T"$TTran"K/Exch_Type2_HALF.dat"    $PathToDtbFldr"/kinetics/"${System1}${FldrName}"/T"$TTran"K/Exch_Type2.dat"
  scp $PathToDtbFldr"/kinetics/"${System1}${FldrName}"/T"$TTran"K/Exch_Type2_HALF.dat"    $PathToDtbFldr"/kinetics/"${System2}${FldrName}"/T"$TTran"K/Exch_Type1.dat"

  echo "[MergeExchanges]:   Copying Exchange of O2+C"
  cat $PathToDtbFldr"/kinetics/"${System2}${FldrName}"/T"$TTran"K/Exch_Type1_HALF.dat" >> $PathToDtbFldr"/kinetics/"${System1}${FldrName}"/T"$TTran"K/Exch_Type2.dat"
  cat $PathToDtbFldr"/kinetics/"${System2}${FldrName}"/T"$TTran"K/Exch_Type1_HALF.dat" >> $PathToDtbFldr"/kinetics/"${System2}${FldrName}"/T"$TTran"K/Exch_Type1.dat"
