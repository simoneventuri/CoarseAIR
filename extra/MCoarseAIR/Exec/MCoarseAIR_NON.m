...
Input.Kin.NGroupsOut            = [     20,     20]; %54, 46
% Input.Kin.CGM_Strategy          = [{'RVE'},{'RVE'}];
% Input.Kin.ParamsGroupsOut       = [     36,     31];
% Input.Kin.NGroupsOut            = [     54,     46]; %54, 46
...
Input.Kin.ReadRatesProc         = [2, 2, 0, 2]
...
Input.Tasks.Write_RatesParaview.Proc                   = [false, true, false, true]
...
Input.Tasks.Plot_Populations.ColorIdx                  = 6;
...
%     Input.Kin.Proc.ExchFlg2         = 1;
% 
%     Input.Kin.ReadRatesProc         = [2, 2, 2, 2]
% 
%     Input.Tasks.Plot_Populations.Flg                       = true;
%     Input.Tasks.Plot_Energies.Flg                          = false;
% 
...
%     Input.Kin.Proc.ExchFlg2         = 1;
%     
%     Input.Kin.ReadRatesProc         = [0, 2, 0, 2]
% 
%     Input.Tasks.Plot_Populations.Flg                       = true;
