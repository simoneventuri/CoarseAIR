...
%Input.RunSuffix                 = '_DP54';
Input.RunSuffix                 = '_RVE54';

Input.Kin.MolResolutionIn       = [{'CGM'},{'CGM'}];
Input.Kin.CGM_Strategy          = [{'File'},{'File'}];
...
if     strcmp(Input.RunSuffix, '_DP10')
    Input.Kin.PathToMappingIn       = [{'/home/venturi/WORKSPACE/Air_Database/Run_0D/database/grouping/NON_UMN/NO/LevelsMap_DPM10.csv'}, ...
                                       {'/home/venturi/WORKSPACE/Air_Database/Run_0D/database/grouping/NON_UMN/N2/LevelsMap_DPM10.csv'}];
    Input.Kin.NGroupsIn             = [     10,     10]; % 49,     83
elseif strcmp(Input.RunSuffix, '_DP20')
    Input.Kin.PathToMappingIn       = [{'/home/venturi/WORKSPACE/Air_Database/Run_0D/database/grouping/NON_UMN/NO/LevelsMap_DPM20.csv'}, ...
                                       {'/home/venturi/WORKSPACE/Air_Database/Run_0D/database/grouping/NON_UMN/N2/LevelsMap_DPM20.csv'}];
    Input.Kin.NGroupsIn             = [     20,     20]; % 49,     83
elseif strcmp(Input.RunSuffix, '_DP54')
    Input.Kin.PathToMappingIn       = [{'/home/venturi/WORKSPACE/Air_Database/Run_0D/database/grouping/NON_UMN/NO/LevelsMap_DPM46.csv'}, ...
                                       {'/home/venturi/WORKSPACE/Air_Database/Run_0D/database/grouping/NON_UMN/N2/LevelsMap_DPM54.csv'}];
    Input.Kin.NGroupsIn             = [     46,     54]; % 49,     83
elseif strcmp(Input.RunSuffix, '_RVE54')
    Input.Kin.PathToMappingIn       = [{'/home/venturi/WORKSPACE/Air_Database/Run_0D/database/grouping/NON_UMN/NO/LevelsMap_RVE46.csv'}, ...
                                       {'/home/venturi/WORKSPACE/Air_Database/Run_0D/database/grouping/NON_UMN/N2/LevelsMap_RVE54.csv'}];
    Input.Kin.ParamsGroupsIn        = [    0.5,    0.5];
    Input.Kin.NGroupsIn             = [     46,     54]; % 49,     83
end
...
Input.Kin.ReadRatesProc         = [3, 3, 3, 3]
...
Input.Tasks.Write_RatesParaview.MinRate                = [1e-13, 5e-13, 1e-12]
...
Input.Tasks.Plot_EnergyDepletions.Proj                 = [1,2];
...
if (Input.Tasks.All)
    ...
    Input.Kin.ReadRatesProc         = [0, 3, 0, 3]
