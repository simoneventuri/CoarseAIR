...
if     strcmp(Input.RunSuffix, '_DP10')
    Input.Kin.PathToMappingIn       = [{'/home/venturi/WORKSPACE/Air_Database/Run_0D/database/grouping/N2O_UMN/N2/LevelsMap_DPM10.csv'}, ...
                                       {'/home/venturi/WORKSPACE/Air_Database/Run_0D/database/grouping/N2O_UMN/NO/LevelsMap_DPM10.csv'}];
    Input.Kin.NGroupsIn             = [     10,     10]; % 49,     83
elseif strcmp(Input.RunSuffix, '_DP20')
    Input.Kin.PathToMappingIn       = [{'/home/venturi/WORKSPACE/Air_Database/Run_0D/database/grouping/N2O_UMN/N2/LevelsMap_DPM20.csv'}, ...
                                       {'/home/venturi/WORKSPACE/Air_Database/Run_0D/database/grouping/N2O_UMN/NO/LevelsMap_DPM20.csv'}];
    Input.Kin.NGroupsIn             = [     20,     20]; % 49,     83
elseif strcmp(Input.RunSuffix, '_DP54')
    Input.Kin.PathToMappingIn       = [{'/home/venturi/WORKSPACE/Air_Database/Run_0D/database/grouping/N2O_UMN/N2/LevelsMap_DPM54.csv'}, ...
                                       {'/home/venturi/WORKSPACE/Air_Database/Run_0D/database/grouping/N2O_UMN/NO/LevelsMap_DPM46.csv'}];
    Input.Kin.NGroupsIn             = [     54,     46]; % 49,     83
elseif strcmp(Input.RunSuffix, '_RVE54')
    Input.Kin.PathToMappingIn       = [{'/home/venturi/WORKSPACE/Air_Database/Run_0D/database/grouping/N2O_UMN/N2/LevelsMap_RVE54.csv'}, ...
                                       {'/home/venturi/WORKSPACE/Air_Database/Run_0D/database/grouping/N2O_UMN/NO/LevelsMap_RVE46.csv'}];
