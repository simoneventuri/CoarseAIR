...
Input.Paths.ToQCTFldr       = strcat(Input.WORKSPACE_PATH, '/CoarseAIR/O2N_Basel/Test/');
...
Input.SystNameLong          = 'O2N_Basel';
Input.iPES                  = 0;
Input.Suffix                = ''
Input.RunSuffix             = '';

Input.Kin.MolResolutionIn   = ['StS'; 'StS'];
Input.Kin.EqNStatesIn       = [ 5781,  6468];
Input.Kin.MinStateIn        = [    1,     1];
Input.Kin.MaxStateIn        = [ 5781,  6468];
...
Input.Kin.ReadRatesProc     = [false, false, false,  false; ...
                               true, false, false, true]
Input.Kin.RateSource        = 'HDF5'; % CoarseAIR / CG-QCT / HDF5 / PLATO
Input.Kin.ReadOtherSyst     = [false]
Input.Kin.OtherSystInHDF5   = [false]
...
Input.Tasks.Plot_DiatPot.jqnVec                        = [200];
