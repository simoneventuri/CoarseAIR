...
Input.Kin.PathToMappingIn       = [{'/home/venturi/WORKSPACE/Air_Database/Run_0D/database/grouping/CO2_NASA/O2/LevelsMap_CGM_20.csv'}, ...
                                   {'/home/venturi/WORKSPACE/Air_Database/Run_0D/database/grouping/CO2_NASA/CO/LevelsMap_CGM_20.csv'}];
Input.Kin.PathToWriteMappingIn  = [   {''},   {''}];
Input.Kin.NGroupsIn             = [     20,     20];
Input.Kin.MolResolutionOut      = [{'CGM'},{'CGM'}];
Input.Kin.PathToMappingOut      = [{'/home/venturi/WORKSPACE/Air_Database/Run_0D/database/grouping/CO2_NASA/O2/LevelsMap_CGM_20.csv'}, ...
                                   {'/home/venturi/WORKSPACE/Air_Database/Run_0D/database/grouping/CO2_NASA/CO/LevelsMap_CGM_20.csv'}];
