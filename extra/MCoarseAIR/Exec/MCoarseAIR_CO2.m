...
global Input Syst Temp Param Kin
...
Input.Paths.ToHDF5Fldr      = '/home/venturi/WORKSPACE/Mars_Database/HDF5_Database_NEW/'
Input.TranVec               = [5000]
Input.SystNameLong          = 'CO2_NASA'
Input.Kin.MolResolutionIn   = ['StS'; 'StS'] 
Input.Kin.MinStateIn        = [    1,     1]
Input.Kin.MaxStateIn        = [13521,  6115]
...
%h5disp(Syst.HDF5_File)
%Rates.Diss = h5read(Syst.HDF5_File,'/T_', Temp.TNowChar, '_', Temp.TNowChar, '/Rates/Diss/')
