...
%% CO+O
Input.RunFldr      = strcat('/home/venturi/WORKSPACE/CoarseAIR/CO2_ALL_SCATTERING/Test_PES', num2str(Input.iPES), '/')
mO16               = 29148.94559d0;%15.9994d-3;
mO18               = mO16 * 18.0 / 16.0;
...
figure(5)
fig = gcf;
ThetaTrans = cos(Exch.Theta_CM./180.*pi);
ExtVec     = linspace( 0.0, 180.0, 180);
ExtVecUni  = linspace(-1.0,   1.0, 180);
...
ThetaTrans  = -180.0 .* (cos(Exch.Theta_CM./180.*pi)+1.0) ./ 2.0;
