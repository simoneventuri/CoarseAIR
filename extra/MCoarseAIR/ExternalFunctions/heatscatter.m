function outfile = heatscatter(X, Y, xlab, ylab, xlimm, ylimm, SaveFlg, FileName, outname, numbins, markersize, marker, plot_colorbar, plot_lsf)
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    ...
    xlabb             = xlabel(xlab, 'Fontsize', Param.AxisLabelSz, 'FontName', Param.AxisLabelNm);
    xlabb.Interpreter = 'latex';

    ylabb             = ylabel(ylab, 'Fontsize', Param.AxisLabelSz, 'FontName', Param.AxisLabelNm);
    ylabb.Interpreter = 'latex';
