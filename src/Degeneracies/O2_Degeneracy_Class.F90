...
#include "../qct.inc"
  ...
  private
  public    ::    O2_Degeneracy_Type


  Type    ,extends(Degeneracy_Type)          ::   O2_Degeneracy_Type
  contains
    procedure           ::  Initialize                  =>    Initialize_O2_Degeneracy
    procedure           ::  Output                      =>    Output_O2_Degeneracy
    procedure   ,nopass ::  Compute_Degeneracy_State    =>    Compute_O2_Degeneracy_State
  End Type
...
Subroutine Initialize_O2_Degeneracy( This, Input, i_Debug )

  use Input_Class                  ,only:  Input_Type
  
  class(O2_Degeneracy_Type)                 ,intent(out)    ::    This
...
Subroutine Output_O2_Degeneracy( This, Unit )

  class(O2_Degeneracy_Type)               ,intent(in)     ::    This
