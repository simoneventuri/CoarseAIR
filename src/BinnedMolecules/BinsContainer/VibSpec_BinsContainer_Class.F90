...
!---------------------------------------------------------------------------------------------------------------
!===============================================================================================================
Module VibSpec_BinsContainer_Class
...
#include "../../qct.inc"
  ...
  private
  public    ::    VibSpec_BinsContainer_Type


  Type    ,extends(BinsContainer_Type)          ::    VibSpec_BinsContainer_Type
    
  contains
    procedure          ::  Initialize            =>    Initialize_VibSpec_BinsContainer    
    procedure          ::  Compute_Level_To_Bin  =>    Compute_Level_To_Bin_VibSpec_BinsContainer  
  End Type
...
! **************************************************************************************************************
! **************************************************************************************************************
!                               DEFERRED PROCEDURES for VibSpec BinsContainer
! **************************************************************************************************************
! **************************************************************************************************************
!________________________________________________________________________________________________________________________________!
Subroutine Initialize_VibSpec_BinsContainer( This, Input, LevelsContainer, iMol, WriteFlg, i_Debug )

  use Input_Class             ,only:  Input_Type
  use LevelsContainer_Class   ,only:  LevelsContainer_Type

  class(VibSpec_BinsContainer_Type)           ,intent(inout)  ::    This
  ...
  if (i_Debug_Loc) call Logger%Entering( "Initialize_VibSpec_BinsContainer" )
...
!________________________________________________________________________________________________________________________________!
Subroutine Compute_Level_To_Bin_VibSpec_BinsContainer( This, LevelsContainer, i_Debug )
  ...
  i_Debug_Loc = i_Debug_Global; if ( present(i_Debug) )i_Debug_Loc = i_Debug
  if (i_Debug_Loc) call Logger%Entering( "Compute_Level_To_Bin_VibSpec_BinsContainer" )
  !i_Debug_Loc   =     Logger%On()

  
  do iLevels = 1,LevelsContainer%NStates
    LevelsContainer%States(iLevels)%To_Bin = LevelsContainer%States(iLevels)%vqn + 1
  end do
