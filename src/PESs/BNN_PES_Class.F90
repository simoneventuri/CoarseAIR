...
Subroutine Initialize_BNN_PES( This, Input, Atoms, iPES, i_Debug )
 ...
 ! ==============================================================================================================
  ...
  NN_Weights_Folder = trim(adjustl(Input%DtbPath))  // '/Systems/' // trim(adjustl(Input%System)) // '/PESs/BNN/' // trim(adjustl(Input%PES_Model(1))) // '/' // trim(adjustl(Input%PES_ParamsFldr(1)))
