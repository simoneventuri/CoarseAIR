...
#include "../qct.inc"
  ...
  private
  public    ::    N4_UMN_PES_Type


  Type, extends(PES_Type) :: N4_UMN_PES_Type
    real(rkp) ::  shiftof0
  contains
    procedure ::  Initialize     =>    Initialize_N4_UMN_PES
    procedure ::  Output         =>    Output_N4_UMN_PES
    procedure ::  Compute        =>    Compute_N4_UMN_PES_1d
    procedure ::  Potential      =>    N4_UMN_Potential_From_R
    procedure ::  TriatPotential =>    N4_UMN_Potential_From_R_OnlyTriat
  End Type
...
! **************************************************************************************************************
! **************************************************************************************************************
Subroutine Initialize_N4_UMN_PES( This, Input, Atoms, iPES, i_Debug )
  ...
  integer                                                   ::    iP
  character(*)                    ,parameter                ::    Name_PES = 'N4_UMN'
  real(rkp)                                                 ::    Temp
  real(rkp)                                                 ::    veccsd
  real(rkp)                                                 ::    veuse
  ...
  if (i_Debug_Loc) call Logger%Entering( "Initialize_N4_UMN_PES" )
...
Subroutine Output_N4_UMN_PES( This, Unit )

  class(N4_UMN_PES_Type)                  ,intent(in)     ::    This
...
!________________________________________________________________________________________________________________________________!
Function N4_UMN_Potential_From_R( This, R, Q ) result( V )
...
!________________________________________________________________________________________________________________________________!
Function N4_UMN_Potential_From_R_OnlyTriat( This, R, Q ) result( V )
...
!________________________________________________________________________________________________________________________________!
Subroutine Compute_N4_UMN_PES_1d( This, R, Q, V, dVdR, dVdQ )
