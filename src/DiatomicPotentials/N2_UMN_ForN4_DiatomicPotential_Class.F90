...
Module N2_UMN_ForN4_DiatomicPotential_Class
  ...
  Private
  public  ::    N2_UMN_ForN4_DiatomicPotential_Type

  Type  ,extends(DiatomicPotential_Type)  ::    N2_UMN_ForN4_DiatomicPotential_Type
  contains
    procedure         ::    Initialize        =>    Initialize_N2_UMN_ForN4_DiatomicPotential
  ...
  real(rkp)                                 ,parameter      ::    de   = 228.7_rkp 
...
Subroutine Initialize_N2_UMN_ForN4_DiatomicPotential( This, Input, SpeciesName, iMol, Mass1, Mass2, i_Debug )

  use Input_Class               ,only:  Input_Type

  class(N2_UMN_ForN4_DiatomicPotential_Type)  ,intent(out)  ::    This
...
Elemental Function DiatomicPotential_N2( This, R ) result( V )
  ...
  class(N2_UMN_ForN4_DiatomicPotential_Type)  ,intent(in)  :: This
