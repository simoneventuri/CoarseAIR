...
!
      ...
      subroutine EvdMdR
!**********************************************************************
!  The subroutine reads M(nom) and dMSdR(6,6) and calculate the
...
! grad for BJ damping
      ...
      subroutine o4pes_Mod(X,v,dVdX,igrad)
      !**********************************************************************
      ! Subroutine to calculate the potential energy V and gradient dVdX
      ! for given Cartesian coordinate X(12)  
      ! R:    Interatomic bond distance (6)
      ...
      end subroutine o4pes_Mod

end module PES_O4_triplet_umn_v2



program ComputeDiat

  use PES_O4_triplet_umn_v2 ,only: pot, pot_Mod
