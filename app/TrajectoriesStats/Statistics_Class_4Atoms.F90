    ...
    do iCond = 1,NCond
      ...
      if ( iCond == NCond ) then
        ...
        elseif (NCond == 5) then
          ...
          if (ArrDiff == 10) then
            if (i_Debug_Loc) call Logger%Write( "2 Molecules in the Collision; Found an Unbound Fin State (ArrDiff = 10)" )
            iquse = FinCond(iu,iCond) !10 (CHANGED)
          else if (ipart1 == 2) then
            if (i_Debug_Loc) call Logger%Write( "2 Molecules in the Collision; Found an Unbound Fin State (ipart1 = 2), ipart2= ",ipart2)
            iquse = FinCond(iu,iCond) !ipart2 (CHANGED)
          else if (ipart2 == 2) then
            if (i_Debug_Loc) call Logger%Write( "2 Molecules in the Collision; Found an Unbound Fin State (ipart2 = 2), ipart1= ",ipart1)
            iquse = FinCond(iu,iCond) !ipart1 (CHANGED)
          else
            iquse = iquse * This%iskip(iCond)
          end if
