...
Program PostTrajectories
  ...
  type(CrossSections_Type)                              :: CrossSections
...
! ==============================================================================================================
  ...
  write(Tint_char,"(I0)") int(Input%Tint)
  ...
  read( Velocity_char, "(d20.10)" ) gbx
  if (i_Debug_PT) call Logger%Write( "Velocity_char = ", Velocity_char, "; Velocity for Conversion Factor = ", gbx )
  ! ==============================================================================================================
...
! ==============================================================================================================
  ...
  !==============================================================================================================
  ! COUNTING THE "CONTAINERS" REQUIRED
  !==============================================================================================================    
  if ( trim(adjustl(Input%TtraModel)) .eq. "Uniform" ) then
    call CrossSections%DifferentiatingFinalStates( Input, Collision, i_Debug=i_Debug_PT )  
  elseif ( trim(adjustl(Input%TtraModel)) .eq. "Boltzmann" ) then
    call Rates%DifferentiatingFinalStates( Input, Collision, i_Debug=i_Debug_PT ) 
  end if
  ! ===============================================================================================================
  
  
  ! =============================================================================================================
  !   ALLOCATING INITIAL and FINAL CONDITIONS ARRAYS
  ! =============================================================================================================
  call CrossSections%AllocatingIniFinStates( Input, i_Debug=i_Debug_PT )
  ! =============================================================================================================
  ...
  do iMol = 1,1
    ...
    if ( trim(adjustl(Input%TtraModel)) .eq. "Uniform" ) then
      ...
      ! ==============================================================================================================
      !   CREATING HEADER FOR CROSS SECTIONS OUTPUT FILE
      ! ==============================================================================================================
      call CrossSections%CreatingDescriptors( Input, Collision, i_Debug=i_Debug_PT, i_Debug_Deep=i_Debug_PT_Deep )
      ! ==============================================================================================================
    
      ! ==============================================================================================================
      !   ALLOCATING CROSS SECTIONS
      ! ==============================================================================================================
      call CrossSections%Allocating( Input, Collision, Molecule(iMol), Input%BinOI(iMol), i_Debug=i_Debug_PT )
      ! ==============================================================================================================
    
      ! ==============================================================================================================
      !   READING INITIAL AND FINAL CONDITIONS AND CROSS SECTIONS FROM statistics.out
      ! ==============================================================================================================
      call CrossSections%ReadingComputing( Input, Collision, Molecule, i_Debug=i_Debug_PT_Medium, i_Debug_Deep=i_Debug_PT_Deep )
      ! ==============================================================================================================
    
      ! ==============================================================================================================
      !   WRITING CROSS SECTIONS
      ! ==============================================================================================================    
      call CrossSections%Writing( Input, Collision, Molecule(iMol), iMol, Input%BinOI(iMol), Input%BinOI_char(iMol), TranInt_char, Tint_char, Input%NTraj, i_Debug=i_Debug_PT )
      ! ==============================================================================================================
    ...
    elseif ( trim(adjustl(Input%TtraModel)) .eq. "Boltzmann" ) then
      ...
      ! ==============================================================================================================
      call Rates%CreatingDescriptors( Input, Collision, i_Debug=i_Debug_PT, i_Debug_Deep=i_Debug_PT_Deep )
      ! ==============================================================================================================
    
      ! ==============================================================================================================
      !   ALLOCATING RATES
      ! ==============================================================================================================
      call Rates%Allocating( Input, Collision, Molecule(iMol), Input%BinOI(iMol), i_Debug=i_Debug_PT )
      ! ==============================================================================================================
      
      ! ==============================================================================================================
      !   READING INITIAL AND FINAL CONDITIONS AND CROSS SECTIONS FROM statistics.out
      ! ==============================================================================================================
      call CrossSections%ReadingComputingRates( Input, Rates, Collision, Molecule, gbx, i_Debug=i_Debug_PT_Medium, i_Debug_Deep=i_Debug_PT_Deep )
      ! ==============================================================================================================

      ! ==============================================================================================================
      !   WRITING RATES
      ! ==============================================================================================================    
      call Rates%Writing( Input, Collision, Molecule(iMol), iMol, Input%BinOI(iMol), Input%BinOI_char(iMol), TranInt_char, Tint_char, Input%NTraj, i_Debug=i_Debug_PT )
      ! ==============================================================================================================
